...
const deleteLiveClass = async (id) => {
  ...
  <img src={process.env.PUBLIC_URL + "/Mathmaster.png"} alt="logo" className="admin-logo" />
  <h2>MATH MASTER – Admin Panel</h2>
</div>
  ...
  onClick={() => {
    ...
    window.location.href = "https://admin.mathmaster.co.in"; // admin login path
  }}
>
  Logout
</button>

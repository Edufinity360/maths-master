...
const [recForm, setRecForm] = useState({
  ...
  "http://localhost:6002/api/admin/students",
  {
    params: {
      ...filter,
  ...
  try {
    const res = await axios.delete(
      `http://localhost:6002/api/admin/students/${id}`
    );
...
const submitHomework = async () => {
  try {
    await axios.post("http://localhost:6002/api/admin/homework", hwForm);
    setHwForm({
      title: "",
      description: "",
      class: "",
...
const deleteHomework = async (id) => {
  ...
  await axios.delete(
    `http://localhost:6002/api/admin/homework/${id}`
  );
  fetchHomework();
};
...
const deleteRecording = async (id) => {
  await axios.delete(
    `http://localhost:6002/api/recordings/${id}`
  );
  fetchRecordings();
};
...
const fetchAdmins = async () => {
  try {
    const { data } = await axios.get("http://localhost:6002/api/admin");
...
const createAdmin = async () => {
  try {
    await axios.post("http://localhost:6002/api/admin/create", adminForm);
    alert("Admin added");
...
const deleteAdmin = async (id) => {
  ...
  try {
    await axios.delete(`http://localhost:6002/api/admin/${id}`);
    fetchAdmins();
  } catch (err) {
    alert("Delete failed");
  }
  ...
  const submitLiveClass = async () => {
    try {
      await axios.post("http://localhost:6002/api/live-classes", {
        class: form.class,
        board: form.board,
...
const fetchLiveClasses = async () => {
  try {
    const { data } = await axios.get(
      "http://localhost:6002/api/live-classes/admin"
    );
...
const deleteLiveClass = async (id) => {
  ...
  try {
    await axios.delete(
      `http://localhost:6002/api/live-classes/${id}`
    );
    fetchLiveClasses();
  } catch (err) {
    alert("Delete failed");
  ...
  const fetchNotes = async () => {
    try {
      const { data } = await axios.get("http://localhost:6002/api/notes", {
        params: filter,
      });
  ...
  try {
    ...
    await axios.post("http://localhost:6002/api/notes", fd);
  ...
  const deleteNote = async (id) => {
    await axios.delete(`http://localhost:6002/api/notes/${id}`);
    fetchNotes();
  };
